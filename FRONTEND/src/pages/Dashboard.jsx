...
export const Dashboard = () => {
  ...
  return (
    <div className={`max-w-6xl mx-auto transition-all duration-500 ${isDark ? 'text-white' : 'text-gray-900'}`}>
      {/* Welcome Section */}
      <div className={`${classes.card} backdrop-blur-md rounded-2xl p-6 mb-8 shadow-2xl ${classes.border} border-2`}>
        <div className="flex items-center justify-between">
          <div>
            <h1 className={`text-3xl font-bold ${classes.text} mb-2 drop-shadow-lg`}>
              Welcome back, @{user.username}!
            </h1>
            <p className={`${classes.textSecondary} drop-shadow-md`}>
          ...
          <div className={`w-16 h-16 ${isDark ? 'bg-gradient-to-r from-orange-400 to-blue-400' : 'bg-gradient-to-r from-orange-500 to-blue-500'} rounded-full flex items-center justify-center overflow-hidden shadow-lg`}>
            {user.profilePicture ? (
              ...
              <span className={`${classes.text} font-bold text-2xl`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Link
          to="/profile"
          className={`${classes.card} backdrop-blur-md rounded-xl p-6 hover:${classes.surfaceHover} transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1`}
        >
          <WalletIcon className={`w-8 h-8 ${classes.secondary} mb-3`} />
          <h3 className={`${classes.text} font-semibold mb-2`}>Profile</h3>
          <p className={`${classes.textMuted} text-sm`}>Update your profile and settings</p>
        </Link>
        ...
        <Link
          ...
          className={`${classes.card} backdrop-blur-md rounded-xl p-6 hover:${classes.surfaceHover} transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1`}
        >
          <UserGroupIcon className={`w-8 h-8 ${classes.accent} mb-3`} />
          <h3 className={`${classes.text} font-semibold mb-2`}>Contacts</h3>
        ...
        <Link
          ...
          className={`${classes.card} backdrop-blur-md rounded-xl p-6 hover:${classes.surfaceHover} transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1`}
        >
          <PaperAirplaneIcon className={`w-8 h-8 ${classes.secondary} mb-3`} />
          <h3 className={`${classes.text} font-semibold mb-2`}>Send</h3>
          <p className={`${classes.textMuted} text-sm`}>Send SOL and SPL tokens</p>
        </Link>
        ...
        <Link
          ...
          className={`${classes.card} backdrop-blur-md rounded-xl p-6 hover:${classes.surfaceHover} transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1`}
        >
          <ClockIcon className={`w-8 h-8 ${classes.accent} mb-3`} />
          <h3 className={`${classes.text} font-semibold mb-2`}>History</h3>
          <p className={`${classes.textMuted} text-sm`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Contacts */}
        <div className={`${classes.card} backdrop-blur-md rounded-xl p-6 shadow-xl`}>
          <h3 className={`${classes.text} font-semibold text-lg mb-4`}>Recent Contacts</h3>
            ...
            <div key={contact.username} className="flex items-center space-x-3 py-2">
              <div className={`w-8 h-8 ${isDark ? 'bg-gradient-to-r from-orange-400 to-blue-400' : 'bg-gradient-to-r from-orange-500 to-blue-500'} rounded-full flex items-center justify-center overflow-hidden shadow-md`}>
                {contact.profilePicture ? (
                  ...
                  <span className={`${classes.text} text-xs font-semibold`}>
                    {contact.username.charAt(0).toUpperCase()}
                  </span>
                )}
              </div>
              <div>
                <p className={`${classes.text} font-medium`}>@{contact.username}</p>
                <p className={`${classes.textMuted} text-sm`}>{contact.bio || 'No bio available'}</p>
              </div>
            </div>
          )) || <p className={`${classes.textMuted}`}>No contacts yet</p>}
        </div>

        {/* Recent Transactions */}
        <div className={`${classes.card} backdrop-blur-md rounded-xl p-6 shadow-xl`}>
          <h3 className={`${classes.text} font-semibold text-lg mb-4`}>Recent Transactions</h3>
          ...
          )) || <p className={`${classes.textMuted}`}>No transactions yet</p>}
        </div>
      </div>
    </div>
  );
